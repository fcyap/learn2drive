  ...
  <head>
    ...
    <div class="container mx-auto p-4">
      <div class="space-y-0.5 mb-6">
        ...
        <p class="text-sm sm:text-base text-gray-600">Your learning journey at a glance</p>
      </div>
      ...
      <div class="flex-col md:flex">
        <div class="flex-1 space-y-4 pt-6">
          ...
          <Card class="bg-slate-100 rounded-lg shadow-md p-4 border border-slate-200">
            ...
            <CardContent>
              <div class="space-y-4 sm:space-y-8">
                <div v-for="lesson in nextWeekLessons" :key="lesson.id" class="flex flex-col sm:flex-row sm:items-center">
                  <Avatar :class="'h-9 w-9 mb-2 sm:mb-0'">
                    <AvatarImage :src="`https://avatar.vercel.sh/${lesson.instructor_name.replace(' ', '-')}.png`"
                      alt="Avatar" />
                    <AvatarFallback>{{ lesson.instructor_name.split(' ').map(n => n[0]).join('') }}</AvatarFallback>
                  </Avatar>
                  <div class="sm:ml-4 space-y-1">
                  ...
                  <div class="mt-2 sm:mt-0 sm:ml-auto font-medium text-slate-600">{{ lesson.location }}</div>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card class="bg-slate-100 rounded-lg shadow-md p-4 border border-slate-200">
            ...
            <CardContent>
              <div class="space-y-4 sm:space-y-8" v-if="uniqueInstructors && uniqueInstructors.length">
                <div v-for="lesson in uniqueInstructors" :key="lesson.instructor_id"
                  ...
                  <button
                    class="mt-2 sm:mt-0 sm:ml-auto bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition duration-200"
              ...
              <div class="bg-white rounded-lg p-6 shadow-2xl w-11/12 max-w-md">
                ...
                <form @submit.prevent="submitReview">
                  ...
                  <div class="flex items-center justify-center mb-4">
                    ...
                    ]" @click="setRating(star)" @mouseenter="setHoverRating(star)" @mouseleave="setHoverRating(0)"
